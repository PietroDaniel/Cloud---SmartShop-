...
public class ProdutoController {
    ...
    @GET
	@Produces(MediaType.APPLICATION_JSON)
	@Path("/buscarprod/{ codigoDeBarras }")
	public Produto consultarPorCodigoDeBarras(@PathParam("codigoDeBarras") String codigoDeBarras) {
		return service.consultarPorCodigoDeBarras(codigoDeBarras);
	}
